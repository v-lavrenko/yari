...
END {
    ...
    if (I) fmt = "%9d: %4.0f ± %5.0f [%4.0f %4.0f %4.0f %4.0f %4.0f |%4.0f| %4.0f %4.0f %4.0f %4.0f %4.0f] %8s\n";
    else   fmt = "%9d: %10.4f ± %10.4f [%6.2f %6.2f %6.2f %6.2f %6.2f |%6.2f| %6.2f %6.2f %6.2f %6.2f %6.2f] %8s\n";
    if (I) hmt = "%9s: %4s ± %5s [%4s %4s %4s %4s %4s |%4s| %4s %4s %4s %4s %4s] %4s\n";
    else   hmt = "%9s: %10s ± %10s [%6s %6s %6s %6s %6s |%6s| %6s %6s %6s %6s %6s] %4s\n";
